...
server =                    "198.74.56.210"
app_name =                  "planner"
app_repository =            "git@github.com:danielballan/planner.git"
app_repository_branch =     "master"
app_deployment_root =       "/var/www/#{app_name}"
...
# this value is used.
default_nginx_domains =     "198.74.56.210"
...
# Load linode ahead of rvm.
load 'config/deploy/linode'
...
namespace :nginx do
  ...
  task :setup, :roles => :app , :except => { :no_release => true } do
    ...
    sudo "rm #{nginx_directory_path}/sites-available/#{app_name}.tld"
